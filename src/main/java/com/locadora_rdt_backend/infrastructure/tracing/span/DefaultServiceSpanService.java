...
@Service
public class DefaultServiceSpanService extends AbstractSpanService implements ServiceSpanService {

    public DefaultServiceSpanService(ApplicationTracingService applicationTracingService) {
