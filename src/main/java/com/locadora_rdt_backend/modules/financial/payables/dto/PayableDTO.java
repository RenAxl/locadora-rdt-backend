...
public class PayableDTO implements Serializable {
    ...
    public Long getParentPayableId() {
        return parentPayableId;
    }
    ...
    public void setParentPayableId(Long parentPayableId) {
        this.parentPayableId = parentPayableId;
    }
